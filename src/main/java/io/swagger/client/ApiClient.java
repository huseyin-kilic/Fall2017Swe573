...
public class ApiClient {
    ...
    private String basePath = "http://etkinlik.io/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("apiKey", new ApiKeyAuth("header", "X-ETKINLIK-TOKEN"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://etkinlik.io/api/v1
